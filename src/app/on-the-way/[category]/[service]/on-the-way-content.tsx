...
import { ChevronLeft, Phone, MessageSquare, Clock, User, MapPin } from 'lucide-react'

interface OnTheWayContentProps {
  category: string;
  service: string;
}

export function OnTheWayContent({ category, service }: OnTheWayContentProps) {
    ...
    <div className="min-h-screen bg-[#F8F8F8]">
      ...
      <div className="fixed top-0 left-0 right-0 bg-white z-10 shadow-sm">
        <div className="max-w-xl mx-auto px-4">
          <div className="flex items-center h-14">
            <Link href={`/payment/${category}/${service}/0`}>
              <Button 
                variant="ghost" 
                size="icon"
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4">
        <div className="max-w-xl mx-auto">
          <Link href={`/review/${category}/${service}`}>
            <Button 
